...
def evaluate_pseudo(model, dataloader, loss_fn, metric_fn, param, current_epoch, writer):
    model.eval()
    summary = []
    ...
    for i, data in enumerate(dataloader):
        ...
        output_batch_cropped, depth_dror, pseudo_label = output_batch_cropped.cpu().numpy(), depth_dror.cpu().numpy(), pseudo_label.cpu().numpy()
...
if __name__ == '__main__':
    ...
    metrics_mean = evaluate_pseudo(model, dataloader_test, net.loss_fn_pseudo, net.metric_fn, param, param['current_epoch'], writer)
